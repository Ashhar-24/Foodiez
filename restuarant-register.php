    ...
    <div class="wrapper">
        ...
        <?php if(isset($regmsg)) {echo $regmsg;} ?>
            <div class="input-field">
                ...
                <input type="text" name="name" id="name" class="input" placeholder="Restuarant" autocomplete="off">

            </div>

            <div class="input-field">
                <label for="number" class="input-label">Mobile </label>
                <input type="text" name="number" id="phone" class="input" placeholder="Enter your mobile"  autocomplete="off">
            ...
            <div class="input-field">
                ...
                <input type="text" name="email" id="email" class="input" placeholder="Enter your email"  autocomplete="off">
            ...
            <div class="input-field">
                ...
                <input type="text" name="state" id="state" class="input" placeholder="Enter your area Pincode"  autocomplete="off">
            ...
            <div class="input-field">
                ...
                <input type="text" name="address" id="address" class="input" placeholder="Enter your Address" autocomplete="off">
